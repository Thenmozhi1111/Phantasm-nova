...
export default function EventHero({ icon, image, accent = 'arcane' }) {
  ...
  if (image) {
    return (
      <div className="event-hero" style={{ '--hero-glow': glow }}>
        <img src={image} alt="" className="event-hero-photo" />
        <div className="event-hero-photo-veil" />
        {Icon && (
          <div className="event-hero-icon event-hero-icon-corner">
