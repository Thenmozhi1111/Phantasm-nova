        ...
        <Panel
          ...
          subtitle={
            isPass
              ...
              : "Select any number of events within the parallel constraints. Solo events are ₹150 each; team events are ₹150 per registering student."
          }
        >
          {isPass && (
          ...
          {!isPass &&
            hasTeamEvents && (
              <p className="relative mt-2 text-[10px] leading-relaxed text-amber-300/70">
                Team event payment is
                per student: only your
                own registration ID is
                charged.
              </p>
            )}
