...
import { CalendarDays, ChevronDown, Trophy, Clock } from 'lucide-react';
...
<div className="hidden sm:flex absolute bottom-20 sm:bottom-24 left-1/2 -translate-x-1/2 z-10 flex-col items-center">
  ...
  <div className="mb-3 inline-flex items-center gap-3 rounded-md border border-blue-500/50 bg-[#020817]/70 px-4 py-2 text-xs sm:text-sm font-semibold tracking-[0.15em] text-blue-100 shadow-[0_0_20px_rgba(0,119,255,0.25),inset_0_0_15px_rgba(0,119,255,0.08)] backdrop-blur-md">
  <Clock
    size={14}
